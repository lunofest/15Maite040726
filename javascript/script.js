...
function updateTimer() {
  const targetDate = new Date("july 4, 2026 21:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const phoneNumber1 = '542236806275'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function () {
  // Definir los números de teléfono
  const recipientNumber1 = '542236806275'; // Número para el primer botón
